...
@section('meta')
<title>@lang('user/auth.title.login') | {{config('app.name')}}</title>
<meta property="og:title" content="@lang('user/auth.title.login') | {{config('app.name')}}" />
<meta property="og:site_name" content="@lang('user/auth.title.login') | {{config('app.name')}}" />
<meta property="og:type" content="website" />
<meta property="og:image" content="{{ asset('images/icon.png') }}">
<meta property="og:url" content="{{config('app.url')}}" />
<meta name="twitter:card" content="summary">
<meta name="twitter:title" content="@lang('user/auth.title.login') | {{config('app.name')}}">
