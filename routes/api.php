...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::post('/admin/user/register', [Controllers\AuthAdmin\UserController::class, 'create']);
    Route::put('/admin/user/update-profile', [Controllers\AuthAdmin\UserController::class, 'updateProfile']);
    Route::put('/admin/user/update-password', [Controllers\AuthAdmin\UserController::class, 'updatePassword']);
    Route::delete('/admin/user/{user_id}', [Controllers\AuthAdmin\UserController::class, 'delete']);
    Route::get('/admin/users', [Controllers\AuthAdmin\UserController::class, 'index']);
